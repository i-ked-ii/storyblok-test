...
const Modal = ({ title, children, onClose, duration = 300, showCloseBtn }) => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="fixed z-10 inset-0 overflow-y-auto" ref={modal}>
      <div
        ...
        */}
        ...
        >
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            <button
              type="button"
              className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
              onClick={(e) => modalCloseHandler(e)}
            >
              Cancel
            </button>
